          ...
          <div className=" px-5 py-4 mt-5 mb-5 mx-5">
            <div className="row my-5">
               <div className="col-sm my-auto ">
                  <h4>WELCOME TO </h4>
                  <h1 className="text-pink"> ROTARACT CLUB OF WESTERN MINDANAO STATE UNIVERSITY </h1>
               ...
               <div className="col-sm mt-5">
                  <img src={image1} width="100%" height="100%" alt="serve qr" />
               </div>
            </div>
                   ...
                   <div className="col  mx-2 mb-3 ">
                     <div style={{ textAlign: 'center' }}  >
                        ...
                        <div className="col  p-4 mx-2 mb-3" >
                           ...
                           <br/>
                           <h4>About</h4>
                  <h2 className="text-pink">  Rotaract Club of Western Mindanao State University</h2>
            ...
            <footer>
               <div class="container">
                  <div class="row">
                     ...
                     <FaIcons.FaFacebook className="me-4" onClick={handleClick3} size="5vh" />
