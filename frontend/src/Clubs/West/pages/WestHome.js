      ...
      > 
         ...
         <div className=" container-fluid bg-pink p-5 text-white">
            <div className="col-sm-6">
               ...
               <p>
                  "The Rotaract Zamboanga City West of RI District 3850 is composed of Rotaractors from Zamboanga City, Western Mindanao ages 18-30 years old."
               </p>
            </div>
            </div>
               ...
               <div class="container">
                  <div class="row">
                      <div class="  mt-3 text-center">
                        ...
                        <SiIcons.SiGmail className="me-4" onClick={handleClick2} size="5vh" /> 
                        <FaIcons.FaInstagram className="me-4" onClick={handleClick1} size="5vh" />
                      </div>
                  </div>
                  <p className="copyright">Rotaract Club of Zamboanga City West</p>
               </div>
            </footer>
            </div>
